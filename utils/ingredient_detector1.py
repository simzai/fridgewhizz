...
def detect_ingredients(image_bytes: bytes):
    """
    Detect visible food ingredients using Gemini 2.5 Flash image-capable model.
    """

    try:
        model = genai.GenerativeModel("models/gemini-2.5-flash-image")

        # ✅ Directly pass image bytes as a dict (no .types.Part)
        ...
        return ingredients or ["No ingredients detected"]
